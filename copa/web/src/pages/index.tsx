    ...
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center'>
      <main>
        ...
        <h1 className='mt-14 text-white text-5xl font-bold leading-tight'>
          Crie seu bolão da copa e compartilhe entre amigos!
        </h1>
        ...
        <div className='mt-10 flex items-center gap-2 '>
          ...
          <strong className='text-gray-100 text-xl'>
            <span className='text-ignite-500'>+{props.userCount}</span> pesssoas já estão usando
          </strong>
        </div>
        ...
        <p className='mt-4 text-sm text-gray-300 leading-relaxed'>
          Após criar seu bolão, você receberá um código único que poderá usar para convidar outras pesssoas 🚀
        </p>
      ...
      <Image 
        src={appPreviewImg} 
        alt="Dois celulares exibindo uma preva da aplicação móvel do NLW Copa" 
        quality={100}
      />
    </div>
  )
